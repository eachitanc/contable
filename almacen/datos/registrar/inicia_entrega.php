...
try {
    ...
    $sql = "SELECT 
                `id_entrada`, `id_tercero_api`, `id_tipo_entrada`, `no_factura`, `acta_remision`, `fec_entrada`, `observacion`, `identificador`, `estado`, `vigencia`
            FROM
                `seg_entrada_almacen`
...
<div class="px-0">
    <div class="shadow">
        ...
        <div class="px-4">
            <form id="formRegEntraAlmacen">
                <input type="hidden" id="id_tercero" name="id_tercero_pd" value="<?php echo $id_tercero ?>">
                <input type="hidden" id="id_inalmacen" name="id_inalmacen" value="<?php echo $id_inalmacen ?>">
                ...
                <div class="form-row text-center">
                    <div class="form-group col-md-12">
                        <label for="txtObserva" class="small">Observaciones</label>
                        <textarea class="form-control" id="txtObserva" name="txtObserva" rows="3"><?php echo $observacion ?></textarea>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="text-center pt-3">
        <button type="button" class="btn btn-primary btn-sm" id="btnRegEntraAlmacen">Continuar <span class="fas fa-arrow-alt-circle-right fa-lg"></span></button>
