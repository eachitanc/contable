                ...
                <div class="container-fluid p-2">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" id="divCuerpoPag">
                            ...
                            <table id="tableEntradasAlmacen" class="table table-striped table-bordered table-sm nowrap table-hover shadow" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>ID api</th>
                                ...
                                <tbody id="modificarConfEntradas">
                                </tbody>
                            </table>
                        </div>
                    </div>
