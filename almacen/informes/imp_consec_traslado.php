...
$finicio = isset($_POST['fInicio']) ? $_POST['fInicio'] : $_SESSION['vigencia'] . '-01-01';
$ffin = isset($_POST['fFin']) ? $_POST['fFin'] : $_SESSION['vigencia'] . '-12-31';
...
try {
    $sql = "SELECT
            ...
            WHERE (`seg_traslados_almacen`.`fec_traslado`  BETWEEN '$finicio' AND '$ffin')
...
?>
<form id="formConsecTrasl">
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="fInicio" class="small">Inicio</label>
            <input type="date" name="fInicio" id="fInicio" class="form-control form-control-sm" value="<?php echo $finicio ?>">
        </div>
        <div class="form-group col-md-4">
            <label for="fFin" class="small">Fin</label>
            <input type="date" name="fFin" id="fFin" class="form-control form-control-sm" value="<?php echo $ffin ?>">
        </div>
        <div class="form-group col-md-1">
            <label class="small">&nbsp;</label>
            <div>
                <a type="button" id="btnFiltraTraslado" class="btn btn-outline-warning btn-sm" title="Filtrar">
                ...
                <tr style="padding: bottom 3px; color:black">
                    <td colspan="5">
                        <table style="width:100% !important;">
                            ...
                            <tr>
                                <td colspan="7">
                                    <b>CONSECUTIVOS DE TRASLADOS ENTRE EL <?php echo $finicio ?> Y EL <?php echo $ffin ?></b>
                                </td>
