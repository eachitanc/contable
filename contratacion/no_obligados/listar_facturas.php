...
<body class="sb-nav-fixed <?php if ($_SESSION['navarlat'] == '1') {
    ...
    <div id="layoutSidenav">
        ...
        <div class="modal fade" id="divModalConfDel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="divMsgConfdel" style="overflow-y: scroll;height: 70vh; width: 100%;">
                    </div>
        ...
        <!-- Modal -->
        <!-- Modal -->
        <div class="modal fade" id="divModalProcess" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div id="divTamModalForms" class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content" style="background-color: #bad0e1; color:#1D80F7">
