...
switch ($opcion) {
    case '1':
        ...
        try {
            ...
            $sql = "INSERT INTO `seg_novedad_contrato_adi_pror`(`id_tip_nov`,`id_adq`,`val_adicion`,`fec_adcion`,`fec_ini_prorroga`,`fec_fin_prorroga`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
    ...
    case '2':
        ...
        try {
            $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
            $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
            $sql = "INSERT INTO `seg_novedad_contrato_cesion`(`id_adq`,`id_tipo_nov`,`id_tercero`,`fec_cesion`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
    ...
    case '3':
        ...
        try {
            $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
            $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
            $sql = "INSERT INTO `seg_novedad_contrato_suspension`(`id_adq`,`id_tipo_nov`,`fec_inicia`,`fec_fin`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
            $sql->bindParam(1, $id_contrato, PDO::PARAM_INT);
            $sql->bindParam(2, $tip_nov, PDO::PARAM_INT);
    ...
    case '4':
        ...
        try {
            $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
            $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
            $sql = "INSERT INTO `seg_novedad_contrato_reinicio`(`id_tipo_nov`,`id_suspension`,`fec_reinicia`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
            $sql->bindParam(1, $tip_nov, PDO::PARAM_INT);
    ...
    case '5':
        ...
        try {
            $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
            $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
            $sql = "INSERT INTO `seg_novedad_contrato_terminacion`(`id_tipo_nov`,`id_t_terminacion`,`id_adq`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
            $sql->bindParam(1, $tip_nov, PDO::PARAM_INT);
    ...
    case '6':
        ...
        try {
            $cmd = new PDO("$bd_driver:host=$bd_servidor;dbname=$bd_base;$charset", $bd_usuario, $bd_clave);
            $cmd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);
            $sql = "INSERT INTO `seg_novedad_contrato_liquidacion`(`id_tipo_nov`,`id_t_liq`,`id_adq`,`fec_liq`,`val_cte`,`val_cta`,`observacion`,`id_user_reg`,`fec_reg`)
                    VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $sql = $cmd->prepare($sql);
            $sql->bindParam(1, $tip_nov, PDO::PARAM_INT);
