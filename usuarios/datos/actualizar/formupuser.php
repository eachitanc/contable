            ...
            <form id="formAddUser">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txtccUpUser" name="txtccUpUser" value="<?php echo $obj['documento'] ?>" placeholder="Identificación">
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="email" class="form-control form-control-sm" id="mailUpuser" name="mailUpuser" value="<?php echo $obj['correo'] ?>" placeholder="usuario@correo.com">
                    </div>
