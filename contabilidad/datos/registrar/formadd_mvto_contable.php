        ...
        <form id="formAddMvtoCtb">
            <div class="form-row px-4 pt-2">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" name="numDoc" id="numDoc" class="form-control form-control-sm" required value="" onfocus="buscarConsecutivoCont2('NCON')">
                    <input type="hidden" name="tipo_dato" id="tipo_dato" class="form-control form-control-sm" value='NCON'>
                </div>
