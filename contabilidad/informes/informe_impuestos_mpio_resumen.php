    ...
    <div class="px-2 " style="width:90% !important;margin: 0 auto;">
        ...
        <table class="table-bordered bg-light" style="width:100% !important;" border=1>
            ...
            foreach ($causaciones as $rp) {
                // consulta la cuenta contable en seg_ctb_libaux cuando id_rte sea igual a id_retencion
                $sql = "SELECT `seg_ctb_libaux`.`cuenta`  AS cuenta FROM `seg_ctb_libaux` WHERE `seg_ctb_libaux`.`id_rte` = {$rp['id_retencion']} LIMIT 1;";
                $res = $cmd->query($sql);
                $cta = $res->fetch();
                $cuenta = $cta['cuenta'];
