      ...
      buttons: [
        {
          ...
          action: function (e, dt, node, config) {
            $.post("datos/registrar/formadd_mvto_contable.php", function (he) {
...
// Editar un registro de detalles de seg_ctb_libaux
const editarRegistroDetalle = (id) => {
  // consulto y cargo los valores registrados en el id de la tabla seg_ctb_libaux
  let boton = document.getElementById("registrarMvtoDetalle");
...
// Eliminar documento contable seg_ctb_doc
