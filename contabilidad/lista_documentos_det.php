...
if (isset($_POST['id_doc'])) {
    try {
        $sql = "SELECT id_ctb_doc,fecha,id_manu,detalle,id_tercero,tipo_doc FROM seg_ctb_doc WHERE id_ctb_doc=$id_doc";
        $rs = $cmd->query($sql);
        $datosMov = $rs->fetch();
    ...
    try {
        $sql = "SELECT id_pto_doc FROM seg_pto_mvto WHERE id_ctb_doc=$id_doc";
        $rs = $cmd->query($sql);
        $datosCrp = $rs->fetch();
    ...
    /*
    try {
        $sql = "SELECT sum(valor) as valor FROM seg_pto_mvto WHERE id_pto_doc=$id_crp GROUP BY id_pto_doc";
        $rs = $cmd->query($sql);
        $sumaCrp = $rs->fetch();
...
if (isset($_POST['id_crp'])) {
    try {
        $sql = "SELECT id_tercero, fecha, objeto FROM seg_pto_documento WHERE id_pto_doc=$id_crp";
        $rs = $cmd->query($sql);
        $datosCrp = $rs->fetch();
...
if (isset($_POST['id_doc'])) {
    try {
        $sql = "SELECT sum(valor) as valor FROM seg_pto_mvto WHERE id_ctb_doc=$id_doc AND tipo_mov='COP' GROUP BY id_pto_doc";
        $rs = $cmd->query($sql);
