...
FROM (
    ...
    FROM
        ...
        FROM
            ...
            INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
            INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
        WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'RED' AND seg_pto_documento.fecha BETWEEN '$fecha_ini' AND '$fecha_corte' 
        GROUP BY seg_pto_cargue.cod_pptal
        ) AS reduccion ON (seg_pto_cargue.cod_pptal=reduccion.cod_pptal)
        LEFT JOIN (
        SELECT
            seg_pto_cargue.cod_pptal
            , seg_pto_cargue.nom_rubro    
        ...
        FROM
            ...
            INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
            INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
        WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'RED' AND seg_pto_documento.fecha BETWEEN '$fecha_ini_mes' AND '$fecha_corte' 
        GROUP BY seg_pto_cargue.cod_pptal
        ) AS reduccion_mes ON (seg_pto_cargue.cod_pptal=reduccion_mes.cod_pptal)
        LEFT JOIN (
        ...
        SELECT cod_pptal,nom_rubro,SUM(valor) AS valor FROM (	
            ...
            FROM
                ...
                INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
                INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
            WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'RAD' AND date_format(seg_pto_documento.fecha,'%Y-%m-%d') BETWEEN '$fecha_ini_mes' AND '$fecha_corte'
            UNION ALL
            SELECT
                seg_pto_cargue.cod_pptal
                , seg_pto_cargue.nom_rubro    
        ...
        SELECT cod_pptal,nom_rubro,SUM(valor) AS valor FROM (	
            ...
            FROM
                ...
                INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
                INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
            WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'REC' AND seg_pto_documento.fecha BETWEEN '2023-01-01' AND '2023-01-31'
            UNION ALL
            SELECT
                seg_pto_cargue.cod_pptal
                , seg_pto_cargue.nom_rubro    
        ...
        ) AS recaudo_mes1 ON (seg_pto_cargue.cod_pptal=recaudo_mes1.cod_pptal)
        LEFT JOIN (
        SELECT cod_pptal,nom_rubro,SUM(valor) AS valor FROM (	
            SELECT
                seg_pto_cargue.cod_pptal
            ...
            FROM
                ...
                INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
                INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
            WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'REC' AND seg_pto_documento.fecha BETWEEN '2023-02-01' AND '2023-02-28'
            UNION ALL
            SELECT
                seg_pto_cargue.cod_pptal
                , seg_pto_cargue.nom_rubro    
        ...
        ) AS recaudo_mes2 ON (seg_pto_cargue.cod_pptal=recaudo_mes2.cod_pptal)
        LEFT JOIN (
        SELECT cod_pptal,nom_rubro,SUM(valor) AS valor FROM (	
            SELECT
                seg_pto_cargue.cod_pptal
            ...
            FROM
                ...
                INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
                INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
            WHERE seg_pto_presupuestos.id_pto_tipo = 1 AND seg_pto_mvto.tipo_mov = 'REC' AND seg_pto_documento.fecha BETWEEN '2023-03-01' AND '2023-03-31'
            UNION ALL
            SELECT
                seg_pto_cargue.cod_pptal
                , seg_pto_cargue.nom_rubro    
        ...
        ) AS recaudo_mes3 ON (seg_pto_cargue.cod_pptal=recaudo_mes3.cod_pptal)                    
        
    WHERE vigencia = 2023 ) 
AS ejecucion  
INNER JOIN seg_pto_cargue ON(seg_pto_cargue.cod_pptal=ejecucion.cod_pptal)
