...
LEFT JOIN(
	...
	INNER JOIN seg_pto_cargue ON (seg_pto_mvto.rubro = seg_pto_cargue.cod_pptal)
	INNER JOIN seg_pto_documento  ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
	WHERE seg_pto_documento.estado =0 AND seg_pto_documento.fecha BETWEEN '$fecha_ini' AND' $fecha_corte' AND seg_pto_mvto.tipo_mov ='RED' AND seg_pto_mvto.mov =0
        GROUP BY seg_pto_mvto.rubro
...
LEFT JOIN(
	...
	INNER JOIN seg_pto_cargue ON (seg_pto_mvto.rubro = seg_pto_cargue.cod_pptal)
	INNER JOIN seg_pto_documento  ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
	WHERE seg_pto_documento.estado =0 AND seg_pto_documento.fecha BETWEEN '$fecha_ini_mes'AND'$fecha_corte' AND seg_pto_mvto.tipo_mov ='RED' AND seg_pto_mvto.mov =0 
        GROUP BY seg_pto_mvto.rubro
