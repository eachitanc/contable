...
FROM (
    ...
    FROM
        ...
        FROM
            ...
            INNER JOIN seg_pto_documento ON (seg_pto_mvto.id_pto_doc = seg_pto_documento.id_pto_doc)
            INNER JOIN seg_pto_presupuestos ON (seg_pto_documento.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
        WHERE seg_pto_presupuestos.id_pto_tipo = 2 AND seg_pto_mvto.tipo_mov = 'RED' AND seg_pto_documento.fecha BETWEEN '$fecha_ini_mes' AND '$fecha_corte' 
        GROUP BY seg_pto_cargue.cod_pptal
    ...
    AS ejecucion  
LEFT JOIN seg_pto_cargue ON(seg_pto_cargue.cod_pptal=ejecucion.cod_pptal)
LEFT JOIN seg_pto_presupuestos ON (seg_pto_cargue.id_pto_presupuestos = seg_pto_presupuestos.id_pto_presupuestos)
