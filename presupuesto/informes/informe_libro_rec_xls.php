...
<head>
    ...
    header("Content-Disposition: attachment; filename=FORMATO_LIBRO_RECAUDOS.xls");
...
?> <div class="contenedor bg-light" id="areaImprimir">
    <div class="px-2 " style="width:90% !important;margin: 0 auto;">
        ...
        <table class="table-bordered bg-light" style="width:100% !important;">
            ...
            <tr>
                <td colspan="7" style="text-align:center"><?php echo 'RELACION DE RECAUDOS PRESUPUESTALES'; ?></td>
            </tr>
            <tr>
