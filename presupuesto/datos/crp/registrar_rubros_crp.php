...
if (isset($_POST)) {
    ...
    try {
        ...
        if (empty($_POST['id_pto_crp'])) {
            $query = $cmd->prepare("INSERT INTO seg_pto_mvto (id_pto_doc, tipo_mov, rubro, valor,id_auto_dep) VALUES (?, ?, ?, ?, ?)");
            ...
            foreach ($obj as $key => $value) {
                ...
                $sql = "SELECT id_pto_doc,rubro FROM seg_pto_mvto WHERE id_pto_mvto = $key";
