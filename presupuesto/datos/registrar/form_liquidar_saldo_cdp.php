...
try {
    ...
    INNER JOIN `seg_pto_documento` 
     ...
     WHERE (`seg_pto_mvto`.`id_pto_doc` ='$cdp');";
    $res = $cmd->query($sql);
                        ...
                        <table id="tableListaCdp" class="table table-striped table-bordered  table-sm table-hover " style="width: 97%;">
                            ...
                            <tbody>
                                ...
                                foreach ($cdps as $lp) {
                                    ...
                                    try {
                                        $sql = "SELECT sum(valor) as registrado FROM seg_pto_mvto WHERE id_auto_dep = '$lp[id_pto_doc]' AND rubro ='$lp[rubro]' AND (tipo_mov ='CRP' OR tipo_mov ='LRP')";
                                        $res = $cmd->query($sql);
                                    ...
                                    try {
                                        $sql = "SELECT sum(valor) as liberado FROM seg_pto_mvto WHERE id_auto_dep = '$lp[id_pto_doc]' AND rubro ='$lp[rubro]' AND tipo_mov ='LCD'";
                                        $res = $cmd->query($sql);
