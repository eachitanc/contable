...
// consultar valor ppto_aprob en seg_pto_cargue
$sql = "SELECT ppto_aprob FROM seg_pto_cargue WHERE cod_pptal = '$rubro' AND vigencia = $_SESSION[vigencia]";
$rs = $cx->query($sql);
$ppto_aprob = $rs->fetch_assoc();
...
$definitivo =  $ppto_aprob['ppto_aprob'] + $adicion - $reduccion + $credito - $contracredito - $aplazamiento + $desaplazamiento;
