...
try {
    ...
    $rs = $cmd->query($sql);
    $tipodoc = $rs->fetchAll();
    $sql = "SELECT * FROM seg_cargo_empleado ORDER BY descripcion_carg";
    $rs = $cmd->query($sql);
    $cargo = $rs->fetchAll();
    ...
    $rs = $cmd->query($sql);
    $sedes = $rs->fetchAll();
    $sql = "SELECT * FROM `seg_pago_dependiente` WHERE `id_empleado` = $idemp limit 1";
    $rs = $cmd->query($sql);
                                        ...
                                        <select id="slcSedeEmp" name="slcSedeEmp" class="form-control form-control-sm py-0 sm" aria-label="Default select example">
                                            ...
                                            foreach ($sedes as $se) {
                                                ...
                                                if ($se['nombre'] != 'CONVENIOS') {
                                                    echo '<option value="' . $se['id_sede'] . '" ' . $slc . '>' . $se['nombre'] . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-row px-4">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="slcPaisExp" name="slcPaisExp" class="form-control form-control-sm py-0 sm" aria-label="Default select example">
                                            <?php
                                            foreach ($pais as $p) {
                                                echo '<option value="' . $p['id_pais'] . '" selected>' . $p['nombre_pais'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="slcDptoExp" name="slcDptoExp" class="form-control form-control-sm py-0 sm" aria-label="Default select example">
                                            ...
                                            foreach ($dpto as $d) {
                                                $slc = $d['id_dpto'] == $obj['dpto_exp'] ? 'selected' : '';
                                                echo '<option value="' . $d['id_dpto'] . '" ' . $slc . '>' . $d['nombre_dpto'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-row px-4">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="slcDptoNac" name="slcDptoNac" class="form-control form-control-sm py-0 sm" aria-label="Default select example">
                                            ...
                                            foreach ($dpto as $d) {
                                                $slc = $d['id_dpto'] == $obj['dpto_nac'] ? 'selected' : '';
                                                echo '<option ' . $slc . ' value="' . $d['id_dpto'] . '">' . $d['nombre_dpto'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-row px-4">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="slcDptoEmp" name="slcDptoEmp" class="form-control form-control-sm py-0 sm" aria-label="Default select example">
                                            <?php
                                            foreach ($dpto as $d) {
                                                $slc = $d['id_dpto'] == $obj['departamento'] ? 'selected' : '';
                                                echo '<option ' . $slc . ' value="' . $d['id_dpto'] . '">' . $d['nombre_dpto'] . '</option>';
                                            }
                                            ?>
                                        </select>
