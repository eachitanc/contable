...
<nav id="navMenu" class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand sombra-nav" href="<?php echo $_SESSION['urlin'] ?>/inicio.php" title="Inicio"><img class="card-img-top" src="<?php echo $_SESSION['urlin'] ?>/images/logoFinanciero.png" alt="logo"></a>
